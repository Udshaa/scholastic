...
def set_bg_hack_url():
    ...
    st.markdown(
         ...
         <style>
         .stApp {{
             background: url("https://yt3.googleusercontent.com/ytc/APkrFKbxn2TC2LfDFind_umWBn299unVlfyGj2Xmb8TY=s900-c-k-c0x00ffffff-no-rj");
...
def send_email(recipient_email, last_response):
    # Set up the SMTP server
    smtp_server = 'smtp.office365.com'
    port = 587
    sender_email = 'abhishek.mishra@udshaadaas.com'
    ...
    msg['Subject'] = 'Check Your Data-Urgent!'

    # Add the last response to the email body
    body = last_response
...
if recipient_email:
    # Assuming last_response contains the last generated response
    last_response = "This is the last response from the GPT-4 API."
    send_email(recipient_email, last_response)
...
st.title("PubAI - Conversation with your Books")
st.markdown("")
...
if prompt := st.chat_input("What Do You Want To Know?"):
    ...
    if prompt and schemas is not None:
        ...
        st.error("Ah! The You Do Not Have Sufficient Permission.")
